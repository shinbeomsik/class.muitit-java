...
//JOptionPane이 javax폴더아래 swing 폴더아래에 있음을 알려줌 
//위치를 알려주는 역활
...
public class 순차문 {
	...
	public static void main(String[] args) {
		//입력 --> 처리 --> 출력
		//두개의 숫자를 입력을 받고 처리해서 출력
		//프로그래밍은 손으로 치는 값은 전부 String 로 취급 (문자열로 취급)
		//램에 저장공간을 만드는것 ==>선언
		...
		//처리
		//정수로 바꾸어서 처리를 하고 싶으면, 프로그래머가 정수로 바꾸어주는 부품을 사용해 처리
