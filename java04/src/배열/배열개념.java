...
public class 배열개념 {
	...
	public static void main(String[] args) {
		...
		// 싶은 경우 사용하는 부품
		//1. 값을 이미 알고 있는 경우
		int[] jumsu = {10, 20, 30, 40}; //length을 자동으로 만들어거 몇개인지 세서 값을 넣어줌
		...
		System.out.println("전체 갯수 " +  jumsu.length);//이 주소가 가르키는 length변수
		
		jumsu[0] = 100;//첫번째값으로 100을 넣으세요. 10<--100
		System.out.println(jumsu[0]);
		//2. 값을 아직 모르고있지만 먼저 저장공간을 만들어두고 나중에 값을 넣는경우
