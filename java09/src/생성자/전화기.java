...
public class 전화기 {
	// 성질 : 멤버변수 (가격, 모양)
	//public은 아무데서나(다른 패키지에서도) 접근 가능설정 (접근제어자)
	public int price; // 멤버변수는 자동초기화!!! (0)
	public String shape; // 기본형이 아닌경우(참조형) 모두 null로 초기화!!
	
	//눈에 보이지는 않지만 기본 생성자가 만들어져 있음
	//묵시적으로 기본 생성자가 만들어져있음
	//==> 객체 생성할 떄 마다 이 메서드를 자동 호출하여
	//    전화기 객체가 만들어졌음
	
	public 전화기() {
		System.out.println("전화기 객체 만들어졌음");
	}
